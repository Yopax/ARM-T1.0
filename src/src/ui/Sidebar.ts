      ...
      <div class="flex flex-col gap-2.5">
        ...
        <div class="bg-slate-950/70 border border-slate-800 rounded p-2 flex flex-col gap-1 text-[11px]">
          <div class="flex justify-between">
            ...
            <span class="text-slate-200 font-medium">${doc.categoryName}</span>
          </div>
          <div class="flex justify-between">
            <span class="text-slate-500">Familia:</span>
            <span class="text-slate-200 font-medium">${doc.family}</span>
          </div>
          <div class="flex justify-between">
            <span class="text-slate-500">Entidad IFC:</span>
            <span class="text-emerald-400 font-mono font-semibold">${doc.metadata.ifcEntity}</span>
          </div>
        </div>
        ...
        <div class="bg-slate-950/70 border border-slate-800 rounded p-2 flex flex-col gap-1 text-[11px]">
          <div class="flex justify-between">
            ...
            <span class="text-sky-300 font-bold">${doc.familyType}</span>
          </div>
          <div class="flex justify-between">
            <span class="text-slate-500">Material Base:</span>
            <span class="text-slate-300">${doc.typeParameters.defaultMaterial}</span>
          </div>
          <div class="flex justify-between">
        ...
        <div class="flex flex-col gap-2 bg-slate-950/70 border border-slate-800 rounded p-2.5 text-xs">
          <div class="flex items-center justify-between">
            ...
            <input id="prop-input-mark" type="text" value="${doc.instanceParameters.mark}" class="w-24 px-2 py-0.5 bg-slate-900 border border-slate-700 rounded text-sky-400 font-bold outline-none focus:border-sky-500 text-xs" />
          </div>
          ...
          <div class="flex items-center justify-between">
            ...
            <span class="text-slate-200 font-medium">${doc.levelName}</span>
          </div>
        ...
        <div class="bg-slate-950/70 border border-slate-800 rounded p-2.5 flex flex-col gap-1.5 text-xs">
          <div class="flex justify-between">
            ...
            <span class="text-slate-200 font-medium">${doc.geometry.dimensionsString}</span>
          </div>
          <div class="flex justify-between font-mono">
            <span class="text-slate-400">Volumen Concreto:</span>
            <strong class="text-emerald-400 font-bold">${doc.instanceParameters.volume.toFixed(3)} m³</strong>
          </div>
          <div class="flex justify-between font-mono">
          ...
          <div class="flex justify-between font-mono">
            ...
            <strong class="text-purple-400 font-bold">$${doc.instanceParameters.estimatedCost.toFixed(2)}</strong>
          </div>
        </div>
