      ...
      <div class="flex items-center gap-1 shrink-0">
        ...
        ${isSlab ? `
          <button id="btn-ctx-sketch" class="bg-white hover:bg-emerald-50 text-emerald-950 border border-emerald-300 px-2 py-0.5 rounded text-xs font-medium cursor-pointer transition-colors flex items-center gap-1" title="Editar contorno de boceto libre">
            <span>✏️</span> <span>Boceto</span>
          </button>
          <button id="btn-ctx-add-void" class="bg-white hover:bg-amber-50 text-amber-950 border border-amber-300 px-2 py-0.5 rounded text-xs font-medium cursor-pointer transition-colors flex items-center gap-1" title="Añadir perforación o shaft interior (hueco)">
